...
class R3_T01_03_Faktorizacija_TLE_Proizvodi_potpuni_kvadrati
{
    ...
    static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (B > 1)                                  // Ako je jos uvek broj B veci od 1 (a prvi najmanji d > 1000), onda proveravamo da li je B potpun kvadrat
            {
                ...
                if (Kvadrat_od_Korena_od_B != B) { if (a.Contains(B)) a.Remove(B); else a.Add(B); }
            }
